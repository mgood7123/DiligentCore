...
struct StateTransitionDesc
{
    ...
    /// If set to true, the resource content can be discarded by the driver to avoid render target decompression
    /// when transitioning to UAV or COMMON state which may cause pipeline stall.
