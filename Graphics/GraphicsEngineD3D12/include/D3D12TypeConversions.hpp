...
static constexpr HardwareQueueIndex GraphicsQueueId{Uint8{0}};
static constexpr HardwareQueueIndex ComputeQueueId{Uint8{1}};
static constexpr HardwareQueueIndex CopyQueueId{Uint8{2}};
